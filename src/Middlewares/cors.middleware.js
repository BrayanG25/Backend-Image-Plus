...
const allowedOriginsGetPost = ['http://localhost:4001','http://localhost:5173','http://localhost:3000'];
const allowedOriginsAll = ['http://localhost:4001','http://localhost:5173','http://localhost:3000'];
